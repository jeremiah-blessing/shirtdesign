...
export default class Productelementproduct extends Component {
  render() {
    return (
      <Modal
        trigger={
          <div className="add-product-icon-container">
            ...
            <span className="add-product-icon-container-span">Product</span>
          </div>
        }
      >
        ...
        <Modal.Content>
          <Modal.Description>
            <h1>Images need to be provided!</h1>
          </Modal.Description>
        </Modal.Content>
      </Modal>
    );
